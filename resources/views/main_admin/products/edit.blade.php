            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="mb-3 col-md-3 col-lg-4 col-sm-2">
                        ...
                        <input type="text" class="form-control" name="Category_eng"
                            value="{{ $products->Category_eng }}">
                        @error('Category_eng')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-3 col-lg-4 col-sm-2">
                        ...
                        <input type="text" class="form-control" name="Description_eng"
                            value="{{ $products->Description_eng }}">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-3 col-lg-4 col-sm-2">
                        ...
                        <input type="text" class="form-control" name="Category_ar"
                            value="{{ $products->Category_ar }}">
                        @error('Category_ar')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-3 col-lg-4 col-sm-2">
                        ...
                        <input type="text" class="form-control" name="Material_ar"
                            value="{{ $products->Material_ar }}">
                        @error('Material_ar')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="mb-3 col-md-3 col-lg-4 col-sm-2">
                        ...
                        <input type="text" class="form-control" name="Category_fr"
                            value="{{ $products->Category_fr }}">
                        @error('Category_fr')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="mb-3 col-md-3 col-lg-4 col-sm-2">
                        ...
                        <input type="text" class="form-control" name="Material_fr"
                            value="{{ $products->Material_fr }}">
                        @error('Material_fr')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row mb-5">
                    <div class="col-md-12 col-sm-12 col-lg-12" id="previewContainer">
                        <img src="{{ asset($products->thumblnail_prod) }}" class="card-img-top"
                    ...
                    @foreach ($productImages as $imgs)
                        <div>
                            <div class=" card col-md-12">
                                <img src="{{ asset($imgs->image) }}" class="card-img-top"
                                    style="width:330px; height:150px;">
                                <br>
                                <div class=" row justify-content-center">
                                    <h5 class="col-md-3 ">
                                        <a href=" {{ url('/admin/imagesdelete/' . $imgs->id) }}"
                                            class="btn btn-sm btn-danger" title="delete image"><i
                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                        <input type="file" class="custom-file-input"
                                            name="images[{{ $imgs->id }}]">
                                        <label class="custom-file-label" for="images[{{ $imgs->id }}]">Choisire
                                            Images</label>
                                    </div>
