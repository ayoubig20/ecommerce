            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        ...
                        {{asset('client/img/instagram/instagram-2.jpg')}}"></div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <span><img src="{{asset('client/img/icon/calendar.png')}}" alt=""> 16 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <span><img src="{{asset('client/img/icon/calendar.png')}}" alt=""> 21 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            <span><img src="{{asset('client/img/icon/calendar.png')}}" alt=""> 28 February 2020</span>
